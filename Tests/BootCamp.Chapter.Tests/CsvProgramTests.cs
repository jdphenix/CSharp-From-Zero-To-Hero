...
namespace BootCamp.Chapter.Tests
{
    ...
    public class CsvProgramTests : IDisposable
    {
        ...
        public void Main_When_Valid_Time_Command_Creates_File_And_Writes_Stats_For_Every_Hour()
        {
            ...
            const string expectedOutput = "Expected/Csv/FullDay.csv";
        ...
        public void Main_When_Valid_Time_Command_With_Range_Creates_File_And_Writes_Stats_For_Every_Hour_Belonging_To_Range()
        {
            ...
            const string expectedOutput = "Expected/Csv/Night.csv";
            AssertMatchingContents(expectedOutput, OutputFile);
        }
        ...
        public void Main_When_Valid_DailyRevenue_Command_Creates_File_And_Writes_Revenue_For_Each_Day_Of_Week()
        {
            ...
            const string expectedOutput = "Expected/Csv/DailyKwiki.csv";
            AssertMatchingContents(expectedOutput, OutputFile);
        }

        [Theory]
        [InlineData("city -money -max", "Expected/Csv/CityItemsMax.csv")]
        [InlineData("city -money -min", "Expected/Csv/CityItemsMin.csv")]
        [InlineData("city -items -max", "Expected/Csv/CityMoneyMax.csv")]
        [InlineData("city -items -min", "Expected/Csv/CityMoneyMin.csv")]
        ...
        public void Main_When_Valid_Full_Command_Creates_Files_Based_On_Shop_With_All_Transactions()
        {
            ...
            {
                AssertMatchingContents("Expected/Csv/Aibe.csv", "Aibe.csv");
                AssertMatchingContents("Expected/Csv/Kwiki Mart.csv", "Kwiki Mart.csv");
                AssertMatchingContents("Expected/Csv/Wallmart.csv", "Wallmart.csv");
            }
        }
